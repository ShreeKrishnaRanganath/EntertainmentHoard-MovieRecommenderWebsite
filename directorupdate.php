...
if ($conn->connect_error) {
 ...
 $q = " update `director` set `id`=$id, `Name`='$name', `Date Of Birth`='$date', `Age`='$age', `Language`='$language' where `id`=$id  ";

 $query = mysqli_query($conn,$q);

 header('location:directoredit.php');
 }
...
<head>
 <title>Director</title>
  ...
  background-image: linear-gradient(
          ...
          url(http://localhost/dbmsminiproject/images/directorupdate.jpg);
